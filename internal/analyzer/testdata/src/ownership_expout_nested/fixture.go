...
type Processor interface { // want `IFG001-OWNERSHIP: interface ifaceguard-testdata/ownership_expout_nested\.Processor has implementation ifaceguard-testdata/ownership_expout_nested\.BasicProcessor`
	Process() error
}
